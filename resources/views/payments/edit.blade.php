        ...
        <x-auth-validation-errors class="mb-4" :errors="$errors" />
                    ...
                    <form method="POST" action="{{ route('payments.update', $payment) }}">
                        ...
                        <div>
                            ...
                            {{-- <input id="customer_id" class="block mt-1 w-full" type="number" name="customer_id" value="{{ $payment->customer_id }}" required autofocus /> --}}
                        ...
                        <div class="mt-4" >
                            ...
                            <x-input id="amount" class="block mt-1 w-full" type="number" name="amount" value="{{ $payment->amount }}" required autofocus />
                        </div>
                         ...
                         <div class="mt-4" >
                            ...
                            <x-input id="payment_date" class="block mt-1 w-full" type="text" name="payment_date" value="{{ $payment->payment_date }}" required autofocus />
                         ...
                         <div class="mt-4" >
                            ...
                            <x-input id="comment" class="block mt-1 w-full" type="text" name="comment" value="{{ $payment->comment }}" required autofocus />
